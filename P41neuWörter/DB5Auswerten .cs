...
namespace Borys.Nachrichten
{
  ...
  {
    //private static void W5Statistik(string ConnectionString, string dBTabelle)
    //{
    ...
    //private static void WStatistik(string ConnectionString, uint länge, string dBTabelle)
    //{
    //  NullOrEmtpyTest(ConnectionString, dBTabelle);
    //  double rfToken;
    //  using (MySqlConnection con = new MySqlConnection(ConnectionString))
    ...
    //private static void DB5Auswerten(string ConnectionString, string dBTMeldungen, string dBTWoerter, string kennung)
    //{
    ...
    //    if (rMeld.HasRows)
    //    {
    //      (neuWort, nMld, nToken) = WörterAusMeldungen(dBTMeldungen, dBTWoerter, kennung, 5, SQLWrt, rMeld);
    //    }
    //    else
    //    {
    ...
    //private static (int, int) W5ausMld(MySqlCommand SQL, string dBTWoerter, string[] WörterEinerMeldung)
    //{
    //  int neuWort = 0;
    //  int nToken = 0;
    //  string wort1, wort2 = null, wort3 = null, wort4 = null, wort5 = null;
    //  try
    //  {
    ...
    //      wortkette = wort1 + " " + wort2 + " " + wort3 + " " + wort4 + " " + wort5;
    //      nToken++;
    ...
    //      SQL.CommandText = cTextauswertung.CREATE5WOERTER;
    //      _ = SQL.ExecuteNonQuery();
